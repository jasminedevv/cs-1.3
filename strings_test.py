...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('cba', 'abc') is False
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('aaaaaaaaaaaaaab', 'b') == 14
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('abc', 'zab') is None  # last 2 letters, but not first
        assert contains('', '') is False # does an empty string contain itself? My code doesn't think so.
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('abc', 'abcd') == []  # pattern longer than text
        with self.assertRaises(AssertionError, msg='pattern is not a string: abra'):
